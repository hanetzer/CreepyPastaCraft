...
public class CPCEntity {
    ...
    public static void init() {
        ...
        EntityRegistry.registerGlobalEntityID(creepypastacraft.common.entity.passive.EntitySquidward.class, "cpc:squidwardward", EntityRegistry.findGlobalUniqueEntityId());
        EntityRegistry.registerModEntity(creepypastacraft.common.entity.passive.EntitySquidward.class, "cpc:squidward", 2012, CPC.instance, 80, 3, true);
