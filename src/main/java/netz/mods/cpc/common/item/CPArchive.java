...
import netz.mods.cpc.common.item.archive.ArchiveJack;
import netz.mods.cpc.common.item.archive.ArchiveJane;
import netz.mods.cpc.common.item.archive.ArchiveJeff;
import netz.mods.cpc.common.item.archive.ArchiveMoth;
import netz.mods.cpc.common.item.archive.ArchiveRake;
import netz.mods.cpc.common.item.archive.ArchiveSeed;
import netz.mods.cpc.common.item.archive.ArchiveSlend;
import netz.mods.cpc.common.item.archive.ArchiveSmile;
import netz.mods.cpc.common.item.archive.ArchiveSquid;
import netz.mods.cpc.common.item.archive.ArchiveStrid;
