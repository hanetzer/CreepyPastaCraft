...
public class EntityVampireBat extends EntityMob implements IMob
{
	...
	public EntityVampireBat(World par1World)
	{
		super(par1World);
	...
	protected void applyEntityAttributes()
	{
		...
		this.getEntityAttribute(maxHealth).setBaseValue(6.0D);
	}
	...
	protected void updateAITasks()
	{
		...
		if (this.getIsBatHanging())
		{
			if (!this.worldObj.isBlockFullCube(MathHelper.floor_double(this
					.posX), (int) this.posY + 1, MathHelper.floor_double(this
					.posZ)))
			{
		...
		else
		{
			...
			if (this.rand.nextInt(100) == 0 && this.worldObj.isBlockFullCube(MathHelper.floor_double(this.posX), (int) this.posY + 1, MathHelper.floor_double(this.posZ)))
			{
				this.setIsBatHanging(true);
			}
		}
