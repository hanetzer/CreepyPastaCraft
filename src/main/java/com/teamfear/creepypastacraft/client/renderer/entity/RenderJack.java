...
import com.teamfear.creepypastacraft.common.entity.monster.EntityJack;
...
public class RenderJack extends RenderLiving {
    ...
    protected ResourceLocation getTexture(EntityJack entityJack) {
        return new ResourceLocation("com.teamfear.creepypastacraft:textures/entity/jack.png");
    }
